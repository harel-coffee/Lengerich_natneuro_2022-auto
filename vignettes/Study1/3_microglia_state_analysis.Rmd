...
diss_stress <- read.csv("/inst/extdata/diss_stress.csv")
...
write.csv(markers, file = "/inst/extdata/Study1_microglia_cluster_markers.csv")
```

```{r}
markers <- read.csv("/inst/extdata/Study1_microglia_cluster_markers.csv", header = T, row.names = 1)
